...
const todos = () => {
//   const todos = [
//     { title: "jmbvm,ghf", desc: "jmg" },
//     { title: "jmbvm,ghf", desc: "jmg" },
//     { title: "jmbvm,ghf", desc: "jmgkh" },
//     { title: "jmbvm,ghf4", desc: "jmgkh" },
//     { title: "jmji", desc: "jmgkh" },
//   ];
        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
              Your Todos will show up here. Please add a todo from Home.
            </p>}
          </div>
                ...
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    <img
                      ...
                      src={`https://picsum.photos/500/700?a=${item.title}`}
                    />
                    <div class="w-full">
