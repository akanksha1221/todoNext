...
const Edit = () => {
    ...
    const updateTodo = () => {
        ...
        if(todos){
          ...
          // return length if todo is already present
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div class="bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <button onClick={updateTodo} class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none w-fit hover:bg-indigo-600 rounded text-lg">
              Update Todo
            </button>
